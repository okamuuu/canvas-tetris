...
Tetris.prototype.createRandomShape = function() {

    var id = Math.floor( Math.random() * baseShapes.length );
   
    return this.createShape(id);
};
...
Tetris.prototype.clearLines = function(board) {
